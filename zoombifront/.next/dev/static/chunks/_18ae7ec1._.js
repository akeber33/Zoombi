...
function DashboardPage() {
    ...
    const [profileEditing, setProfileEditing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const loadData = async ()=>{
        try {
            ...
            const [dashboard, professores, materias, anotacoes, perfil] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teachersApi"].getAll(),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].getAll(),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notesApi"].getAll(),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileApi"].get()
            ]);
    ...
    const saveTeacher = async ()=>{
        try {
            ...
            if (editingTeacher) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teachersApi"].update(editingTeacher.id, {
                    nome: teacherForm.nome,
                    email: teacherForm.email,
                    disciplina: teacherForm.disciplina
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teachersApi"].create({
                    nome: teacherForm.nome,
                    email: teacherForm.email,
                    disciplina: teacherForm.disciplina
                });
    ...
    const deleteTeacher = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teachersApi"].delete(id);
            await loadData();
        } catch (error) {
    ...
    const saveSubject = async ()=>{
        try {
            ...
            let materiaId;
            if (editingSubject) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].update(editingSubject.id, payload);
                ...
                if (editingSubject.trabalhos) {
                    for (const trabalho of editingSubject.trabalhos){
                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].deleteTrabalho(materiaId, trabalho.id);
                    }
                }
            } else {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].create(payload);
                materiaId = result.id;
            }
            // Criar trabalhos novos
            for (const trabalho of subjectForm.trabalhos){
                if (trabalho.titulo.trim()) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].addTrabalho(materiaId, {
    ...
    const deleteSubject = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subjectsApi"].delete(id);
            await loadData();
        } catch (error) {
    ...
    const saveNote = async ()=>{
        try {
            ...
            if (editingNote) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notesApi"].update(editingNote.id, payload);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notesApi"].create(payload);
            }
            await loadData();
            setNoteModal(false);
            setNoteForm({
    ...
    const deleteNote = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notesApi"].delete(id);
            await loadData();
        } catch (error) {
    ...
    const saveProfile = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileApi"].update({
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        subjectForm.trabalhos.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardPage, "4teIg5P4HKAOXL1oOTHvKqHw3dg=");
_c = DashboardPage;
var _c;
