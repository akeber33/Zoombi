...
function DashboardPage() {
    ...
    const saveTeacher = async ()=>{
        try {
            ...
            if (editingTeacher) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["teachersApi"].update(editingTeacher.id, {
    ...
    const deleteTeacher = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["teachersApi"].delete(id);
            await loadData();
        } catch (error) {
    ...
    const saveSubject = async ()=>{
        try {
            ...
            let materiaId;
            if (editingSubject) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subjectsApi"].update(editingSubject.id, payload);
    ...
    const deleteSubject = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subjectsApi"].delete(id);
            await loadData();
        } catch (error) {
    ...
    const saveNote = async ()=>{
        try {
            ...
            if (editingNote) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notesApi"].update(editingNote.id, payload);
            } else {
    ...
    const deleteNote = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notesApi"].delete(id);
            await loadData();
        } catch (error) {
