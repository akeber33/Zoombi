...
;
const metadata = {
    title: 'Zoombi - Organização Estudantil',
    description: 'Plataforma completa para organização e acompanhamento de estudos. Gerencie suas matérias, professores e anotações em um só lugar.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
