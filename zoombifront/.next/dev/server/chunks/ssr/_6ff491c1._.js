...
const assignmentsApi = {
    ...
    getAllBySubject: (materiaId)=>fetchApi(`/Materias/${materiaId}/Trabalhos`),
    // Obter um trabalho específico pelo ID
    getById: (trabalhoId)=>fetchApi(`/Trabalhos/${trabalhoId}`),
    // Criar um novo trabalho
    create: (trabalho)=>fetchApi('/Trabalhos', {
            method: 'POST',
            body: JSON.stringify(trabalho)
        }),
    // Atualizar um trabalho
    update: (trabalhoId, trabalho)=>fetchApi(`/Trabalhos/${trabalhoId}`, {
            method: 'PUT',
            body: JSON.stringify({
                ...trabalho,
                id: trabalhoId
    ...
    toggleCompleted: (trabalhoId, concluido)=>fetchApi(`/Trabalhos/${trabalhoId}/concluir`, {
            method: 'PUT',
            body: JSON.stringify({
                concluido
            })
    ...
    // Deletar um trabalho
    delete: (trabalhoId)=>fetchApi(`/Trabalhos/${trabalhoId}`, {
            method: 'DELETE'
        })
};
const classesApi = {
    // Obter todas as aulas de UMA matéria
    getAllBySubject: (materiaId)=>fetchApi(`/Materias/${materiaId}/Aulas`),
    // Obter uma aula específica
    getById: (aulaId)=>fetchApi(`/Aulas/${aulaId}`),
    // Criar um novo registro de aula (ex: registrar aula de hoje)
    create: (aula)=>fetchApi('/Aulas', {
            method: 'POST',
            body: JSON.stringify(aula)
        }),
    // Atualizar uma aula (ex: mudar data, observações)
    update: (aulaId, aula)=>fetchApi(`/Aulas/${aulaId}`, {
            method: 'PUT',
            body: JSON.stringify({
                ...aula,
                id: aulaId
    ...
    updateAttendance: (aulaId, presente)=>fetchApi(`/Aulas/${aulaId}/presenca`, {
            method: 'PUT',
            body: JSON.stringify({
                presente
            })
    ...
    delete: (aulaId)=>fetchApi(`/Aulas/${aulaId}`, {
            method: 'DELETE'
        })
};
const studentApi = {
...
function DashboardPage() {
    ...
    const loadDashboardData = async ()=>{
        try {
            ...
            const [dashboardData, studentData, statsData] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studentApi"].getProfile(),
    ...
    const saveSubject = async ()=>{
        try {
            ...
            if (editingSubject) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subjectsApi"].update(parseInt(editingSubject.id), {
                    nome: subjectForm.nome,
                    cor: subjectForm.cor,
                    professorId: parseInt(subjectForm.professorId)
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subjectsApi"].create({
                    nome: subjectForm.nome,
                    cor: subjectForm.cor,
                    professorId: parseInt(subjectForm.professorId)
                });
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: editingSubject ? "Atualize as informações da matéria" : "Adicione uma nova matéria ao sistema"
                                }, void 0, false, {
                                    fileName: "[project]/app/dashboard/page.tsx",
                                    lineNumber: 1083,
                                    columnNumber: 13
...
//# sourceMappingURL=_6ff491c1._.js.map